...
// tz-gen — parse IANA tzdata TZif files and emit bxp-core/src/tz_data.zig.
//
...
pub fn main(init: std.process.Init) !void {
    ...
    _ = it.next(); // exe name
    const out_path = try gpa.dupe(u8, it.next() orelse "../../bxp-core/src/tz_data.zig");
...
fn emit(gpa: std.mem.Allocator, io: std.Io, out_path: []const u8, version: []const u8, zones: []const ZoneOut) !void {
    ...
    try w.print(
        \\// GENERATED by tools/tz-gen from IANA tzdata {s}. DO NOT EDIT.
        \\// Regenerate: cd tools/tz-gen && zig build run
        \\//
