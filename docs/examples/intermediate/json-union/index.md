...
[:material-github: View on GitHub](https://github.com/zaxified/bxp/tree/master/docs/examples/intermediate/json-union){ .md-button }

!!! abstract "What"
    Merge several JSON exports whose objects carry **different key sets**
...
=== "sample.json (config)"
    ...
    ```js
    --8<-- "examples/intermediate/json-union/sample.json"
    ```

=== "crm_alpha.in.json"

    ```json
    --8<-- "examples/intermediate/json-union/crm_alpha.in.json"
    ```
