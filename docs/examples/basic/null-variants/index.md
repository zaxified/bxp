...
[:material-github: View on GitHub](https://github.com/zaxified/bxp/tree/master/docs/examples/basic/null-variants){ .md-button }
...
=== "sample.json (config)"
    ...
    ```js
    --8<-- "examples/basic/null-variants/sample.json"
    ```
