...
[:material-github: View on GitHub](https://github.com/zaxified/bxp/tree/master/docs/examples/real-world/ruian-address-points){ .md-button }
...
Government open-data registers ship as a _zip of many
