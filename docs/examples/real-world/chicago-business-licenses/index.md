...
[:material-github: View on GitHub](https://github.com/zaxified/bxp/tree/master/docs/examples/real-world/chicago-business-licenses){ .md-button }

!!! abstract "What"
    Turn the City of Chicago's raw Business Licenses export into a
...
=== "sample.json (config)"
    ...
    ```js
    --8<-- "examples/real-world/chicago-business-licenses/sample.json"
    ```
