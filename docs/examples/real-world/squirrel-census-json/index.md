...
[:material-github: View on GitHub](https://github.com/zaxified/bxp/tree/master/docs/examples/real-world/squirrel-census-json){ .md-button }

!!! abstract "What"
    Flatten the 2018 NYC Central Park Squirrel Census — published as a
...
=== "sample.json (config)"
    ...
    ```js
    --8<-- "examples/real-world/squirrel-census-json/sample.json"
    ```
