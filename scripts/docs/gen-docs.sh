...
#
# The four Dart-catalog pages (gui-agent-tools.md, gui-shortcuts.md,
# gui-prefs.md, environment.md) can't be read by the Zig tool (language
# boundary), so they are generated by tools/dart-doc-gen, which runs as a
# `flutter test` (importing bxp_gui links dart:ui). All generated pages — Zig
# and Dart alike — are covered by the --check drift guard below.
